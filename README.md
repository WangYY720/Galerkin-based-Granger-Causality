...
## Introduction 
This code accompanies the research paper: **Wang, Y., Kou, J., Noack, B. R., & Zhang, W. (2026). [Causal analysis of a turbulent shear flow model](https://www.cambridge.org/core/journals/journal-of-fluid-mechanics/article/abs/causal-analysis-of-a-turbulent-shear-flow-model/F41277BC4B322FC39FFCE1FBFEAD80F2)**. 
In this work, we proposed a modified Granger causality method, **GGC**, specifically designed for causal inference on Galerkin-type and data-driven ROMs of complex fluid flows. GGC takes time-resolved modal coefficients (e.g., from Galerkin projection or POD) as input and outputs a causal map that reveals directional cause-and-effect between modes. It was validated on two benchmark flows: a turbulent shear flow model ([Moehlis et al. 2004](https://iopscience.iop.org/article/10.1088/1367-2630/6/1/056))  and a lid-driven cavity flow ([Arbabi & Mezić 2017](https://journals.aps.org/prfluids/abstract/10.1103/PhysRevFluids.2.124402)). For detailed descriptions and results, please refer to the research paper.
